...
prompt = ChatPromptTemplate.from_messages([
    ("system", """You are a clinical drug interaction specialist for Abilify (aripiprazole).
...
1. pubmed_search — search PubMed for peer-reviewed clinical articles about Abilify or aripiprazole drug interactions. Use ONLY when FDA context is insufficient OR when the query asks about latest/recent research.
...
def pubmed_search(query:str)->str:
    """Search PubMed for peer reviewed clinical articles about Abilify or aripiprazole drug interactions. Use when FDA label
